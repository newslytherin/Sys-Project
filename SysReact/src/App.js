      ...
      <Router>
        <div>
          <ul className="header">
            ...
            {this.state.loggedIn && this.state.roles.includes("user") ? (
              <li>
            ...
            {this.state.loggedIn && this.state.roles.includes("admin") ? (
              <li>
          ...
          <Route
            path="/user"
            render={() => (
              <User username={this.state.username} roles={this.state.roles} />
            )}
          />
          <Route
            path="/admin"
            render={() => (
              <Admin username={this.state.username} roles={this.state.roles} />
            )}
          />
